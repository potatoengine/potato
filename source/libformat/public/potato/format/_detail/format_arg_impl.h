...
up::format::result_code FORMATXX_API up::format::_detail::basic_format_arg<CharT>::format_into(basic_format_writer<CharT>& output, basic_format_options<CharT> const& options) const {
    switch (_type) {
