...
namespace up::shell {
    void ImGuiComponentReflector::onField(up::zstring_view name) { _name = name; }

    void ImGuiComponentReflector::onValue(int& value) { ImGui::InputInt(_name.c_str(), &value); }
    ...
    void ImGuiComponentReflector::onValue(glm::quat& value) {
    ...
    void ImGuiComponentReflector::onValue(glm::mat4x4& value) {
